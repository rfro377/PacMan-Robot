...
void Timer_2_Enable(void) 
{
    ...
    #if (Timer_2_UsingFixedFunction)
        Timer_2_GLOBAL_ENABLE |= Timer_2_BLOCK_EN_MASK;
        Timer_2_GLOBAL_STBY_ENABLE |= Timer_2_BLOCK_STBY_EN_MASK;
...
void Timer_2_Stop(void) 
{
    ...
    #if (Timer_2_UsingFixedFunction)
        Timer_2_GLOBAL_ENABLE &= ((uint8)(~Timer_2_BLOCK_EN_MASK));
        Timer_2_GLOBAL_STBY_ENABLE &= ((uint8)(~Timer_2_BLOCK_STBY_EN_MASK));
...
{
    Timer_2_STATUS_MASK = interruptMode;
}


/*******************************************************************************
* Function Name: Timer_2_SoftwareCapture
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Timer_2_ReadStatusRegister
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Timer_2_ReadControlRegister
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Timer_2_WriteControlRegister
********************************************************************************
*
* Summary:
...
{
   #if(Timer_2_UsingFixedFunction)
       return ((uint32)CY_GET_REG16(Timer_2_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG32(Timer_2_PERIOD_LSB_PTR));
   #endif /* (Timer_2_UsingFixedFunction) */
}
...
void Timer_2_WritePeriod(uint32 period) 
{
    ...
    #else
        CY_SET_REG32(Timer_2_PERIOD_LSB_PTR, period);
...
{
   #if(Timer_2_UsingFixedFunction)
       return ((uint32)CY_GET_REG16(Timer_2_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG32(Timer_2_CAPTURE_LSB_PTR));
   #endif /* (Timer_2_UsingFixedFunction) */
}
...
void Timer_2_WriteCounter(uint32 counter) 
{
    ...
    #else
        CY_SET_REG32(Timer_2_COUNTER_LSB_PTR, counter);
...
*  Timer_2__B_TIMER__CM_NONE        - Set Capture mode to None
*  Timer_2__B_TIMER__CM_RISINGEDGE  - Rising edge of Capture input
*  Timer_2__B_TIMER__CM_FALLINGEDGE - Falling edge of Capture input
*  Timer_2__B_TIMER__CM_EITHEREDGE  - Either edge of Capture input
*
* Return:
*  void
*
...
/*******************************************************************************
* Function Name: Timer_2_SetTriggerMode
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Timer_2_EnableTrigger
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Timer_2_DisableTrigger
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Timer_2_SetInterruptCount
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Timer_2_SetCaptureCount
********************************************************************************
*
* Summary:
...
{
    Timer_2_CAP_COUNT = captureCount;
}


/*******************************************************************************
* Function Name: Timer_2_ReadCaptureCount
********************************************************************************
*
* Summary:
...
{
    return ((uint8)Timer_2_CAP_COUNT);
}
#endif /* Timer_2_UsingHWCaptureCounter */


/*******************************************************************************
* Function Name: Timer_2_ClearFIFO
********************************************************************************
*
* Summary:
...
{
    while(0u != (Timer_2_ReadStatusRegister() & Timer_2_STATUS_FIFONEMP))
    {
        (void)Timer_2_ReadCapture();
    }
}
