...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=true, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=0, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=255, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_2, CY_INSTANCE_SHORT_NAME=PWM_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=PWM_2, )
module PWM_v3_30_1 (
    pwm2,
    tc,
    clock,
...
// QuadDec_v3_0(Counter8bit=true, CounterResolution=1, CounterSize=8, CounterSizeReplacementString=int8, CounterSizeReplacementStringUnsigned=uint8, TypeCastReplacementString=int16, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_1, CY_INSTANCE_SHORT_NAME=QuadDec_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=QuadDec_1, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=128, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=128, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=128, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=8, RunMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=true, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_2:Cnt8, CY_INSTANCE_SHORT_NAME=Cnt8, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=QuadDec_2_Cnt8, )
...
// QuadDec_v3_0(Counter8bit=true, CounterResolution=1, CounterSize=8, CounterSizeReplacementString=int8, CounterSizeReplacementStringUnsigned=uint8, TypeCastReplacementString=int16, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_2, CY_INSTANCE_SHORT_NAME=QuadDec_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=QuadDec_2, )
...
// ADC_SAR_v3_0(ADC_Clock=0, ADC_Clock_Frequency=11368422, ADC_Input_Range=0, ADC_Power=0, ADC_Reference=2, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=true, Ref_Voltage=5, Ref_Voltage_mV=5000, rm_int=true, Sample_Precharge=6, Sample_Rate=0, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_Seq_1:SAR, CY_INSTANCE_SHORT_NAME=SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=ADC_SAR_Seq_1_SAR, )
module ADC_SAR_v3_0_7 (
	...
	cy_psoc3_pins_v1_10
		#(.id("f2404772-c24e-4b44-aedd-281871e48086/dea208d9-07b0-438b-a5e0-ac5d207f2658/7e0d1a6c-1235-4546-a71b-ea6e528924f8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// ADC_SAR_SEQ_v2_0(ADC_Clock_Frequency=1800000, Adjust=0, ClockSource=0, InputRange=0, NumChannels=4, Reference=2, Resolution=12, rm_int=false, SampleMode=0, SamplePrecharge=6, SampleRate=100000, SampleRate_def=631579, VrefValue=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_SEQ_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_Seq_1, CY_INSTANCE_SHORT_NAME=ADC_SAR_Seq_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=ADC_SAR_Seq_1, )
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=11368422, ADC_Input_Range=0, ADC_Power=0, ADC_Reference=2, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=5, Ref_Voltage_mV=5000, rm_int=false, Sample_Precharge=6, Sample_Rate=631579, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_1, CY_INSTANCE_SHORT_NAME=ADC_SAR_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=ADC_SAR_1, )
module ADC_SAR_v3_0_9 (
	...
	cy_psoc3_pins_v1_10
		#(.id("2306ae0d-77e1-46a3-89bb-11530a7d6e0c/7e0d1a6c-1235-4546-a71b-ea6e528924f8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__PW1_1_net;
	wire [0:0] tmpFB_0__PW1_1_net;
	wire [0:0] tmpIO_0__PW1_1_net;
	wire [0:0] tmpINTERRUPT_0__PW1_1_net;
	electrical [0:0] tmpSIOVREF__PW1_1_net;

	cy_psoc3_pins_v1_10
		#(.id("bdb80188-99fa-4187-986f-fe6d5061a4e7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PW1_1
		 (.oe(tmpOE__PW1_1_net),
		  .y({Net_1671}),
		  .fb({tmpFB_0__PW1_1_net[0:0]}),
		  .io({tmpIO_0__PW1_1_net[0:0]}),
		  .siovref(tmpSIOVREF__PW1_1_net),
		  .interrupt({tmpINTERRUPT_0__PW1_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PW1_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PW1_2_net;
	wire [0:0] tmpFB_0__PW1_2_net;
	wire [0:0] tmpIO_0__PW1_2_net;
	wire [0:0] tmpINTERRUPT_0__PW1_2_net;
	electrical [0:0] tmpSIOVREF__PW1_2_net;

	cy_psoc3_pins_v1_10
		#(.id("f3bebd5c-4c08-44fd-be82-d47e788a6b44"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PW1_2
		 (.oe(tmpOE__PW1_2_net),
		  .y({Net_543}),
		  .fb({tmpFB_0__PW1_2_net[0:0]}),
		  .io({tmpIO_0__PW1_2_net[0:0]}),
		  .siovref(tmpSIOVREF__PW1_2_net),
		  .interrupt({tmpINTERRUPT_0__PW1_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PW1_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__chA1_net;
	wire [0:0] tmpIO_0__chA1_net;
	wire [0:0] tmpINTERRUPT_0__chA1_net;
	electrical [0:0] tmpSIOVREF__chA1_net;

	cy_psoc3_pins_v1_10
		#(.id("58de89dc-8e3a-47d8-91ea-d8da59eb93ff"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		chA1
		 (.oe(tmpOE__chA1_net),
		  .y({1'b0}),
		  .fb({Net_3303}),
		  .io({tmpIO_0__chA1_net[0:0]}),
		  .siovref(tmpSIOVREF__chA1_net),
		  .interrupt({tmpINTERRUPT_0__chA1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__chA1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__chA2_net;
	wire [0:0] tmpIO_0__chA2_net;
	wire [0:0] tmpINTERRUPT_0__chA2_net;
	electrical [0:0] tmpSIOVREF__chA2_net;

	cy_psoc3_pins_v1_10
		#(.id("194e040c-596a-48cf-bf9b-ecffed7d8a28"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		chA2
		 (.oe(tmpOE__chA2_net),
		  .y({1'b0}),
		  .fb({Net_3470}),
		  .io({tmpIO_0__chA2_net[0:0]}),
		  .siovref(tmpSIOVREF__chA2_net),
		  .interrupt({tmpINTERRUPT_0__chA2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__chA2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PW2_1_net;
	wire [0:0] tmpFB_0__PW2_1_net;
	wire [0:0] tmpIO_0__PW2_1_net;
	wire [0:0] tmpINTERRUPT_0__PW2_1_net;
	electrical [0:0] tmpSIOVREF__PW2_1_net;

	cy_psoc3_pins_v1_10
		#(.id("bb6edf09-de5d-49df-a80a-1b59eee9dde2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PW2_1
		 (.oe(tmpOE__PW2_1_net),
		  .y({Net_1726}),
		  .fb({tmpFB_0__PW2_1_net[0:0]}),
		  .io({tmpIO_0__PW2_1_net[0:0]}),
		  .siovref(tmpSIOVREF__PW2_1_net),
		  .interrupt({tmpINTERRUPT_0__PW2_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PW2_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PW2_2_net;
	wire [0:0] tmpFB_0__PW2_2_net;
	wire [0:0] tmpIO_0__PW2_2_net;
	wire [0:0] tmpINTERRUPT_0__PW2_2_net;
	electrical [0:0] tmpSIOVREF__PW2_2_net;

	cy_psoc3_pins_v1_10
		#(.id("0b4f30a2-9557-4e35-ae6f-faa57d913111"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PW2_2
		 (.oe(tmpOE__PW2_2_net),
		  .y({Net_1725}),
		  .fb({tmpFB_0__PW2_2_net[0:0]}),
		  .io({tmpIO_0__PW2_2_net[0:0]}),
		  .siovref(tmpSIOVREF__PW2_2_net),
		  .interrupt({tmpINTERRUPT_0__PW2_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PW2_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__chB1_net;
	wire [0:0] tmpIO_0__chB1_net;
	wire [0:0] tmpINTERRUPT_0__chB1_net;
	electrical [0:0] tmpSIOVREF__chB1_net;

	cy_psoc3_pins_v1_10
		#(.id("f86a03a1-df0f-4b7c-aa05-15663007d40c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		chB1
		 (.oe(tmpOE__chB1_net),
		  .y({1'b0}),
		  .fb({Net_3304}),
		  .io({tmpIO_0__chB1_net[0:0]}),
		  .siovref(tmpSIOVREF__chB1_net),
		  .interrupt({tmpINTERRUPT_0__chB1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__chB1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__chB2_net;
	wire [0:0] tmpIO_0__chB2_net;
	wire [0:0] tmpINTERRUPT_0__chB2_net;
	electrical [0:0] tmpSIOVREF__chB2_net;

	cy_psoc3_pins_v1_10
		#(.id("2907058d-081b-4245-add8-0d257bd30085"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		chB2
		 (.oe(tmpOE__chB2_net),
		  .y({1'b0}),
		  .fb({Net_3471}),
		  .io({tmpIO_0__chB2_net[0:0]}),
		  .siovref(tmpSIOVREF__chB2_net),
		  .interrupt({tmpINTERRUPT_0__chB2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__chB2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    ADC_SAR_SEQ_v2_0_8 ADC_SAR_Seq_1 (
        .soc(1'b0),
        .aclk(1'b0),
        .sdone(Net_6415),
        .eoc(Net_6416),
	...
	cy_psoc3_pins_v1_10
		#(.id("ccb694f8-498b-4603-86b7-a5ff8e85b176"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7344a3a1-72db-4177-ac48-1c4ab3e54673"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b2633b5c-856d-4b43-b68b-bd760aaf9299"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3abc067a-3e65-45f8-a1ea-0f921cfb9812"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_10 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_6515),
        .tx_interrupt(Net_6579),
        .rx_interrupt(Net_6580),
        .tx_data(Net_6581),
        .tx_clk(Net_6582),
        .rx_data(Net_6583),
        .rx_clk(Net_6584));
    ...
    Timer_v2_70_12 Timer_2 (
        .reset(Net_6607),
        .interrupt(Net_6608),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_6705),
        .tc(Net_6706),
        .clock(Net_6614));
	...
	cy_clock_v1_0
		#(.id("ce5e0577-54b7-43e6-a21e-5e22b73fb48a"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
