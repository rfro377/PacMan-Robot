...
module UART_v2_50_11 (
	...
	cy_clock_v1_0
		#(.id("21d3fdee-fd5c-4a34-8a12-58f4c773b510/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("2170138888.88889"),
		  .is_direct(0),
...
module top ;
    ...
    UART_v2_50_11 UART_2 (
        ...
        .reset(1'b0),
        .rx(1'b0),
        .tx_interrupt(Net_6591),
        .rx_interrupt(Net_6592),
        .tx_data(Net_6593),
        .tx_clk(Net_6594),
        .rx_data(Net_6595),
        .rx_clk(Net_6596));
    ...
    defparam UART_2.EnIntRXInterrupt = 0;
    ...
    defparam UART_2.RXEnable = 0;
    defparam UART_2.TXEnable = 1;
