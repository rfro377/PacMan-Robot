...
extern uint8 ADC_SAR_1_initVar;
extern volatile int16 ADC_SAR_1_offset;
extern volatile int16 ADC_SAR_1_countsPerVolt; /* Obsolete variable, do not modify in new design */
extern volatile int32 ADC_SAR_1_countsPer10Volt;
extern volatile int16 ADC_SAR_1_shift;
...
#define ADC_SAR_1_STARTED                    (0x02u)
#define ADC_SAR_1_ENABLED                    (0x01u)
#define ADC_SAR_1_DISABLED                   (0x00u)

#define ADC_SAR_1_MAX_FREQUENCY              (18000000)       /* 18Mhz */

#define ADC_SAR_1_10V_COUNTS                 (10.0F)
#define ADC_SAR_1_10MV_COUNTS                (10000)
#define ADC_SAR_1_10UV_COUNTS                (10000000L)
...
#define ADC_SAR_1__FREERUNNING 0
#define ADC_SAR_1__TRIGGERED 1

/*  Extended Sample Mode setting constants */
#define ADC_SAR_1__FREE_RUNNING 0
#define ADC_SAR_1__SOFTWARE_TRIGGER 1
#define ADC_SAR_1__HARDWARE_TRIGGER 2

/*  Clock Source setting constants */
#define ADC_SAR_1__INTERNAL 1
#define ADC_SAR_1__EXTERNAL 0
...
#define ADC_SAR_1_DEFAULT_RESOLUTION     (12u)   /* ADC resolution selected with parameters.*/
...
#define ADC_SAR_1_CLOCK_FREQUENCY        (11368422u)   /* Clock frequency */
#define ADC_SAR_1_NOMINAL_CLOCK_FREQ     (12000000)  /* Nominal Clock Frequency */
#define ADC_SAR_1_HIGH_POWER_PULSE       (0u)        /* Not zero when clock pulse > 50 ns */
...
#define ADC_SAR_1_DEFAULT_REF_VOLTAGE \
...
#define ADC_SAR_1_DEFAULT_POWER \
       ...
       ((ADC_SAR_1_NOMINAL_CLOCK_FREQ > (ADC_SAR_1_MAX_FREQUENCY / 8)) ? ADC_SAR_1__MEDPOWER : \
                                                                                       ADC_SAR_1__MINPOWER))
/* Constant for a global usage */
/* Number of additional clocks for sampling data*/
#define ADC_SAR_1_SAMPLE_PRECHARGE       (6u)
...
#define ADC_SAR_1_SAR_TR0_REG                (* (reg8 *) ADC_SAR_1_ADC_SAR__TR0 )
#define ADC_SAR_1_SAR_TR0_PTR                (  (reg8 *) ADC_SAR_1_ADC_SAR__TR0 )
#define ADC_SAR_1_SAR_CSR0_REG               (* (reg8 *) ADC_SAR_1_ADC_SAR__CSR0 )
#define ADC_SAR_1_SAR_CSR0_PTR               (  (reg8 *) ADC_SAR_1_ADC_SAR__CSR0 )
#define ADC_SAR_1_SAR_CSR1_REG               (* (reg8 *) ADC_SAR_1_ADC_SAR__CSR1 )
#define ADC_SAR_1_SAR_CSR1_PTR               (  (reg8 *) ADC_SAR_1_ADC_SAR__CSR1 )
#define ADC_SAR_1_SAR_CSR2_REG               (* (reg8 *) ADC_SAR_1_ADC_SAR__CSR2 )
#define ADC_SAR_1_SAR_CSR2_PTR               (  (reg8 *) ADC_SAR_1_ADC_SAR__CSR2 )
#define ADC_SAR_1_SAR_CSR3_REG               (* (reg8 *) ADC_SAR_1_ADC_SAR__CSR3 )
#define ADC_SAR_1_SAR_CSR3_PTR               (  (reg8 *) ADC_SAR_1_ADC_SAR__CSR3 )
#define ADC_SAR_1_SAR_CSR4_REG               (* (reg8 *) ADC_SAR_1_ADC_SAR__CSR4 )
#define ADC_SAR_1_SAR_CSR4_PTR               (  (reg8 *) ADC_SAR_1_ADC_SAR__CSR4 )
#define ADC_SAR_1_SAR_CSR5_REG               (* (reg8 *) ADC_SAR_1_ADC_SAR__CSR5 )
#define ADC_SAR_1_SAR_CSR5_PTR               (  (reg8 *) ADC_SAR_1_ADC_SAR__CSR5 )
#define ADC_SAR_1_SAR_CSR6_REG               (* (reg8 *) ADC_SAR_1_ADC_SAR__CSR6 )
#define ADC_SAR_1_SAR_CSR6_PTR               (  (reg8 *) ADC_SAR_1_ADC_SAR__CSR6 )
#define ADC_SAR_1_SAR_SW0_REG                (* (reg8 *) ADC_SAR_1_ADC_SAR__SW0 )
#define ADC_SAR_1_SAR_SW0_PTR                (  (reg8 *) ADC_SAR_1_ADC_SAR__SW0 )
#define ADC_SAR_1_SAR_SW2_REG                (* (reg8 *) ADC_SAR_1_ADC_SAR__SW2 )
#define ADC_SAR_1_SAR_SW2_PTR                (  (reg8 *) ADC_SAR_1_ADC_SAR__SW2 )
#define ADC_SAR_1_SAR_SW3_REG                (* (reg8 *) ADC_SAR_1_ADC_SAR__SW3 )
#define ADC_SAR_1_SAR_SW3_PTR                (  (reg8 *) ADC_SAR_1_ADC_SAR__SW3 )
#define ADC_SAR_1_SAR_SW4_REG                (* (reg8 *) ADC_SAR_1_ADC_SAR__SW4 )
#define ADC_SAR_1_SAR_SW4_PTR                (  (reg8 *) ADC_SAR_1_ADC_SAR__SW4 )
#define ADC_SAR_1_SAR_SW6_REG                (* (reg8 *) ADC_SAR_1_ADC_SAR__SW6 )
#define ADC_SAR_1_SAR_SW6_PTR                (  (reg8 *) ADC_SAR_1_ADC_SAR__SW6 )
#define ADC_SAR_1_SAR_CLK_REG                (* (reg8 *) ADC_SAR_1_ADC_SAR__CLK )
#define ADC_SAR_1_SAR_CLK_PTR                (  (reg8 *) ADC_SAR_1_ADC_SAR__CLK )
#define ADC_SAR_1_SAR_WRK0_REG               (* (reg8 *) ADC_SAR_1_ADC_SAR__WRK0 )
#define ADC_SAR_1_SAR_WRK0_PTR               (  (reg8 *) ADC_SAR_1_ADC_SAR__WRK0 )
#define ADC_SAR_1_SAR_WRK1_REG               (* (reg8 *) ADC_SAR_1_ADC_SAR__WRK1 )
#define ADC_SAR_1_SAR_WRK1_PTR               (  (reg8 *) ADC_SAR_1_ADC_SAR__WRK1 )
#define ADC_SAR_1_SAR_WRK_PTR                (  (reg16 *) ADC_SAR_1_ADC_SAR__WRK0 )
#define ADC_SAR_1_PWRMGR_SAR_REG             (* (reg8 *) ADC_SAR_1_ADC_SAR__PM_ACT_CFG )
#define ADC_SAR_1_PWRMGR_SAR_PTR             (  (reg8 *) ADC_SAR_1_ADC_SAR__PM_ACT_CFG )
#define ADC_SAR_1_STBY_PWRMGR_SAR_REG        (* (reg8 *) ADC_SAR_1_ADC_SAR__PM_STBY_CFG )
#define ADC_SAR_1_STBY_PWRMGR_SAR_PTR        (  (reg8 *) ADC_SAR_1_ADC_SAR__PM_STBY_CFG )

/* renamed registers for backward compatible */
#define ADC_SAR_1_SAR_WRK0                   ADC_SAR_1_SAR_WRK0_REG
#define ADC_SAR_1_SAR_WRK1                   ADC_SAR_1_SAR_WRK1_REG

/* This is only valid if there is an internal clock */
#if(ADC_SAR_1_DEFAULT_INTERNAL_CLK)
    /* Clock Power manager Reg */
    #define ADC_SAR_1_PWRMGR_CLK_REG         (* (reg8 *) ADC_SAR_1_theACLK__PM_ACT_CFG )
    #define ADC_SAR_1_PWRMGR_CLK_PTR         (  (reg8 *) ADC_SAR_1_theACLK__PM_ACT_CFG )
    #define ADC_SAR_1_STBY_PWRMGR_CLK_REG    (* (reg8 *) ADC_SAR_1_theACLK__PM_STBY_CFG )
    #define ADC_SAR_1_STBY_PWRMGR_CLK_PTR    (  (reg8 *) ADC_SAR_1_theACLK__PM_STBY_CFG )
...
#define ADC_SAR_1_ACT_PWR_SAR_EN             (uint8)(ADC_SAR_1_ADC_SAR__PM_ACT_MSK)

/* PM_STBY_CFG (Alternate Active Power Mode CFG Register) Power enable mask */
#define ADC_SAR_1_STBY_PWR_SAR_EN            (uint8)(ADC_SAR_1_ADC_SAR__PM_STBY_MSK)

/* This is only valid if there is an internal clock */
#if(ADC_SAR_1_DEFAULT_INTERNAL_CLK)
    /* Power enable mask */
    #define ADC_SAR_1_ACT_PWR_CLK_EN         (uint8)(ADC_SAR_1_theACLK__PM_ACT_MSK)
    /* Standby power enable mask */
    #define ADC_SAR_1_STBY_PWR_CLK_EN        (uint8)(ADC_SAR_1_theACLK__PM_STBY_MSK)
#endif /*End ADC_SAR_1_DEFAULT_INTERNAL_CLK */

#if(ADC_SAR_1_IRQ_REMOVE == 0u)

    /* Priority of the ADC_SAR_IRQ interrupt. */
    #define ADC_SAR_1_INTC_PRIOR_NUMBER          (uint8)(ADC_SAR_1_IRQ__INTC_PRIOR_NUM)

    /* ADC_SAR_IRQ interrupt number */
    #define ADC_SAR_1_INTC_NUMBER                (uint8)(ADC_SAR_1_IRQ__INTC_NUMBER)
...
#define ADC_SAR_1_SAR_CAP_TRIM_MASK          (0x07u)
#define ADC_SAR_1_SAR_CAP_TRIM_0             (0x00u)    /*decrease attenuation capacitor by 0*/
#define ADC_SAR_1_SAR_CAP_TRIM_1             (0x01u)    /*decrease by 0.5 LSB*/
#define ADC_SAR_1_SAR_CAP_TRIM_2             (0x02u)    /*decrease by 2*0.5 LSB = 1 LSB*/
#define ADC_SAR_1_SAR_CAP_TRIM_3             (0x03u)    /*decrease by 3*0.5 LSB = 1.5 LSB*/
#define ADC_SAR_1_SAR_CAP_TRIM_4             (0x04u)    /*decrease by 4*0.5 LSB = 2 LSB*/
#define ADC_SAR_1_SAR_CAP_TRIM_5             (0x05u)    /*decrease by 5*0.5 LSB = 2.5 LSB*/
#define ADC_SAR_1_SAR_CAP_TRIM_6             (0x06u)    /*decrease by 6*0.5 LSB = 3 LSB*/
#define ADC_SAR_1_SAR_CAP_TRIM_7             (0x07u)    /*decrease by 7*0.5 LSB = 3.5 LSB*/

#define ADC_SAR_1_SAR_TRIMUNIT               (0x08u)    /*Increase by 6fF*/
...
#define ADC_SAR_1_ICONT_FULL_CURRENT         (0x00u)
...
#define ADC_SAR_1_SAR_SOF_STOP_CONV          (0x00u)            /* Disable conversion */
...
#define ADC_SAR_1_SAR_SAMPLE_WIDTH           (ADC_SAR_1_SAMPLE_PRECHARGE - 0x02u)
...
#define ADC_SAR_1_SAR_PWR_CTRL_VCM_1         (0x10u)
#define ADC_SAR_1_SAR_PWR_CTRL_VCM_2         (0x20u)
#define ADC_SAR_1_SAR_PWR_CTRL_VCM_3         (0x30u)

/* Bit Field  SAR_PWR_CTRL_VREF_ENUM */
#define ADC_SAR_1_SAR_PWR_CTRL_VREF_MASK     (0x0Cu)
#define ADC_SAR_1_SAR_PWR_CTRL_VREF_0        (0x00u)
#define ADC_SAR_1_SAR_PWR_CTRL_VREF_DIV_BY2  (0x04u)
#define ADC_SAR_1_SAR_PWR_CTRL_VREF_DIV_BY3  (0x08u)
#define ADC_SAR_1_SAR_PWR_CTRL_VREF_DIV_BY4  (0x0Cu)
...
#define ADC_SAR_1_SAR_OVERRUN_DET_EN_EN      (0x80u)

/* Bit Field  SAR_DLY_INC_ENUM */
#define ADC_SAR_1_SAR_DLY_INC                (0x40u)

/* Bit Field  SAR_DCEN_ENUM */
#define ADC_SAR_1_SAR_DCEN                   (0x20u)
...
#define ADC_SAR_1_SAR_SEL_CSEL_DFT_CHAR      (0x03u)

/*******************************************************/
/* SAR.CSR6 Satatus and Control Register 6 definitions */
/*******************************************************/
#define ADC_SAR_1_INT_VREF                   (0x18u)
#define ADC_SAR_1_INT_BYPASS_EXT_VREF        (0x04u)
#define ADC_SAR_1_VDDA_VREF                  (0x80u)
...
/***********************************************/
#define ADC_SAR_1_SAR_WRK_MAX                (0xFFFu)
#define ADC_SAR_1_SAR_DIFF_SHIFT             (0x800u)

/* Absolute maximum counts equivalent reference voltage */
#define ADC_SAR_1_SAR_WRK_MAX_12BIT          (0x00001000Lu)
#define ADC_SAR_1_SAR_WRK_MAX_10BIT          (0x00000400Lu)
#define ADC_SAR_1_SAR_WRK_MAX_8BIT           (0x00000100Lu)
