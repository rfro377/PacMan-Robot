...
CY_ISR( QuadDec_2_ISR )
{
   ...
   QuadDec_2_swStatus = QuadDec_2_STATUS_REG;
    ...
    #ifdef QuadDec_2_ISR_ENTRY_CALLBACK
        QuadDec_2_ISR_EntryCallback();
    #endif /* QuadDec_2_ISR_ENTRY_CALLBACK */
    ...
    #ifdef QuadDec_2_ISR_EXIT_CALLBACK
        QuadDec_2_ISR_ExitCallback();
    #endif /* QuadDec_2_ISR_EXIT_CALLBACK */
}
