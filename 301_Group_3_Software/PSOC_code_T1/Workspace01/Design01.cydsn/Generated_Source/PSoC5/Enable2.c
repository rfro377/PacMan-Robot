...
*
* \funcusage
*  \snippet Enable2_SUT.c usage_Enable2_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Enable2_SUT.c usage_Enable2_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Enable2_SUT.c usage_Enable2_Read  
*******************************************************************************/
...
* preferred Enable2_Read() API because the 
* Enable2_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Enable2_SUT.c usage_Enable2_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Enable2_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Enable2_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Enable2_0_INTR       (First pin in the list)
    *  - Enable2_1_INTR       (Second pin in the list)
    *  - ...
    *  - Enable2_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Enable2_SUT.c usage_Enable2_SetInterruptMode
    *******************************************************************************/
    void Enable2_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Enable2_0_INTR) != 0u) 
		{ 
			 Enable2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Enable2_SUT.c usage_Enable2_ClearInterrupt
    *******************************************************************************/
