...
*
* \funcusage
*  \snippet Enable1_SUT.c usage_Enable1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Enable1_SUT.c usage_Enable1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Enable1_SUT.c usage_Enable1_Read  
*******************************************************************************/
...
* preferred Enable1_Read() API because the 
* Enable1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Enable1_SUT.c usage_Enable1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Enable1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Enable1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Enable1_0_INTR       (First pin in the list)
    *  - Enable1_1_INTR       (Second pin in the list)
    *  - ...
    *  - Enable1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Enable1_SUT.c usage_Enable1_SetInterruptMode
    *******************************************************************************/
    void Enable1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Enable1_0_INTR) != 0u) 
		{ 
			 Enable1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Enable1_SUT.c usage_Enable1_ClearInterrupt
    *******************************************************************************/
